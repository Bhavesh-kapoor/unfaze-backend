...
import { activateOrDeactivate, register, validateRegister } from "../../controllers/admin/TherepistController.js";
...
therepistRouter.post('/activate-or-deactive',activateOrDeactivate)
