...
const createOrder = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        return res.status(200).json(new ApiResponse(200, { paymentSessionId, order_id }, "order Inialized successfully"));
    } catch (error) {
...
const verifyPayment = asyncHandler(async (req, res,next) => {
   ...
   if (!order_id){
    return res.status(501).json(new ApiError(501,error,"order_id is required"));
   }
    try {
